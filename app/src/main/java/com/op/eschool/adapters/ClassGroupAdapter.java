...
//
//public class ClassGroupAdapter extends BaseTableAdapter {
//    Activity activity ;
//    Context context ;
...
//
//    public ClassGroupAdapter(Activity activity , Context context , List<ClassGroupModel> list) {
...
//
//        for (ClassGroupModel classModel : list){
//            familys[0].list.add(new Nexus(""+classModel.getGroupId() ,
//
//                    ""+classModel.getGroupName(),
//                    ""+classModel.getStaus(),
//                    "","","","","","",""
//
//            )) ;
