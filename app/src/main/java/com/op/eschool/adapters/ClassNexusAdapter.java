...
public class ClassNexusAdapter extends BaseTableAdapter {
    Activity activity ;
    Context context ;
    ...
    public ClassNexusAdapter(Activity activity , Context context , List<ClassModel> list) {
        ...
        for (ClassModel classModel : list){
            familys[0].list.add(new Nexus(""+classModel.getClassId() ,
                    ""+classModel.getClassCode(),
                    ""+classModel.getClassGroup(),
                    ""+classModel.getName(),
                    ""+classModel.getStatus(),
                    "","","","",""
