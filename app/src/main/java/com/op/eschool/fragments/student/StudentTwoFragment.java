...
import static com.op.eschool.base.BaseActivity.bindingStudentTwo;
...
public class StudentTwoFragment extends Fragment {
  private static final String ARG_PARAM1 = "param1";
    ...
    public StudentTwoFragment( CollegeInterface collegeInterface) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bindingStudentTwo = DataBindingUtil.inflate(inflater , R.layout.fragment_student_two, container, false);
        collegeInterface.onRegisterClicked();
        return bindingStudentTwo.getRoot() ;
    }
}