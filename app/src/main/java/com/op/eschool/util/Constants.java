...
public class Constants {
    public static String RESPONSE_SUCCESS = "20" ;
    public static String RESPONSE_FAILED = "40" ;
    public static String LOGIN_RESPONSE = "LOGIN_RESPONSE_V1" ;
    public static String USER_APPROVE = "1" ;
    public static String USER_DELETE = "2" ;
    public static String USER_BLOCK = "3" ;
